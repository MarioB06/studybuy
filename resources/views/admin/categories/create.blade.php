<x-app-layout>
    ...
    <div class="admin-container">
        <h1 style="font-size:32px;font-weight:600;margin-bottom:30px">Neue Kategorie</h1>
        <div class="form-card">
            <form method="POST" action="{{ route('admin.categories.store') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="icon" class="form-input" value="{{ old('icon') }}" placeholder="z.B. fas fa-laptop">
